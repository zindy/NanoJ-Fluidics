...
import nanoj.deviceControl.java.sequentialProtocol.Step;

import javax.swing.*;
import java.awt.*;

import static nanoj.deviceControl.java.sequentialProtocol.GUI.rowHeight;
    ...
    SequentialLabellingLayout(Container host) {
        ...
        topPanelLayout.setVerticalGroup(
                topPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(
                                topPanelLayout.createParallelGroup()
                                        .addComponent(panel.deviceStatusOnSeqLabel)
                                        .addComponent(panel.deviceStatusOnSeq)
                        )
        ...
        for (Step item: panel.sequence) {
            item.addActionListener(panel.updateStepDevice);
